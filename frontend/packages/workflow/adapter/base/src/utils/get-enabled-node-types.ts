...
export const MIRAP_BASE_NODE_TYPES: StandardNodeType[] = [
  ...
  StandardNodeType.MirapBogusFilter,
  StandardNodeType.MirapBogusDetail,
  StandardNodeType.MirapHoverFilter,
  StandardNodeType.MirapHoverEventDetail,
  StandardNodeType.MirapLeanFilter,
  StandardNodeType.MirapLeanDetail,
  StandardNodeType.MirapRemainFilter,
  StandardNodeType.MirapRemainDetail,
  StandardNodeType.MirapRetraceFilter,
  StandardNodeType.MirapSignalSpoofingDetail,
  StandardNodeType.MirapFakeSignalRecover,
  StandardNodeType.MirapTrajectoryQuality,
  StandardNodeType.MirapInterruptFilter,
  StandardNodeType.MirapRepetitionFilter,
  StandardNodeType.MirapInterruptDetail,
  StandardNodeType.MirapLowVelocityDetail,
  StandardNodeType.MirapSpeedFilter,
  StandardNodeType.MirapNoRegularFilter,
  StandardNodeType.MirapOnlineRatioFilter,
];
